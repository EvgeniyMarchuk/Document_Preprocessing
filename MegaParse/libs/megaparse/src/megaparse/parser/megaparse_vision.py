...
from megaparse.src.megaparse.parser import BaseParser
from megaparse.src.megaparse.parser.entity import SupportedModel, TagEnum
...
3. If you encounter image, leave the link in a markdown file in the same place where you recognized this image in original file to this image. Do it in the folowing format:"![Image]".
